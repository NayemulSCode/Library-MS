    ...
    public partial class view_student_info : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (result == DialogResult.OK)//test result
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update student_info set student_name='"+ student_name.Text +"', student_image='"+ img_path.ToString() +"',student_enrollment_no='"+student_enrollment_no.Text+"',student_department='"+student_department.Text+"',student_sem='"+ student_sem.Text +"',student_contact='"+ student_contact.Text +"',student_email='"+ student_email +"' where id="+ i +"";
            ...
            else if (result == DialogResult.Cancel)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update student_info set student_name='"+ student_name.Text +"',student_enrollment_no='"+ student_enrollment_no.Text +"',student_department='"+ student_department.Text +"',student_sem='"+ student_sem.Text +"',student_contact='"+ student_contact.Text +"',student_email='"+ student_email +"' where id="+ i +"";
